    ...
    <div>
        <footer className="bg-indigo-950 text-white pt-16 pb-8">
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-12">
                ...
                <p className="text-indigo-200 mb-4">Innovative learning platform bridging language barriers for Cushitic language communities through accessible, multilingual education.</p>
                ...
                <ul className="space-y-2">
                    ...
                    <li><a href="#" className="text-indigo-200 hover:text-white">Courses</a></li>
                    <li><a href="#" className="text-indigo-200 hover:text-white">Blog</a></li>
                    <li><a href="#" className="text-indigo-200 hover:text-white">About Us</a></li>
                ...
                <ul className="space-y-2">
                    <li><a href="#" className="text-indigo-200 hover:text-white">Knowledge Base</a></li>
                    <li><a href="#" className="text-indigo-200 hover:text-white">Support Center</a></li>
                    <li><a href="#" className="text-indigo-200 hover:text-white">Terms of Service</a></li>
                    <li><a href="#" className="text-indigo-200 hover:text-white">Privacy Policy</a></li>
                    <li><a href="#" className="text-indigo-200 hover:text-white">Accessibility</a></li>
                </ul>
                </div>
                <div>
                ...
                <ul className="space-y-4">
                    ...
                    <span className="text-indigo-200">123 Tech Hub, Innovation Street, Addis Ababa, Ethiopia</span>
                    </li>
                    <li className="flex items-start">
                    <svg className="w-6 h-6 mr-2 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span className="text-indigo-200">contact@cushlearn.com</span>
                    </li>
                    <li className="flex items-start">
                    <svg className="w-6 h-6 mr-2 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span className="text-indigo-200">+251 912 345 678</span>
                    </li>
                </ul>
                </div>
            </div>
            ...
            <div className="border-t border-indigo-800 pt-8">
                ...
                <p className="text-indigo-300 mb-4 md:mb-0">© 2025 CushLearn. All rights reserved.</p>
                <div className="flex space-x-6">
                    <a href="#" className="text-indigo-300 hover:text-white text-sm">Terms of Service</a>
                    <a href="#" className="text-indigo-300 hover:text-white text-sm">Privacy Policy</a>
                    <a href="#" className="text-indigo-300 hover:text-white text-sm">Cookie Policy</a>
                </div>
                </div>
            </div>
            </div>
