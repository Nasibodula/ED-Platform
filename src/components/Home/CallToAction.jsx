    ...
    <div>
        <section className="py-16 bg-gradient-to-r from-teal-900 to-teal-800 text-white">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                <button className="bg-white text-teal-900 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition">
                Get Started for Free
                </button>
                <button className="bg-transparent border-2 border-white hover:bg-white hover:text-teal-800 text-white px-6 py-3 rounded-lg font-medium transition">
                Request a Demo
                </button>
            </div>
            </div>
