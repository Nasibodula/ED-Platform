    ...
    <div>
        <section className="py-16 bg-gray-50">
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="p-6">
                    <h3 className="font-bold text-indigo-800 text-lg mb-2">How does the offline functionality work?</h3>
                ...
                <div className="mb-6 bg-white rounded-xl shadow-md overflow-hidden">
                <div className="p-6">
                    <h3 className="font-bold text-indigo-800 text-lg mb-2">Which Cushitic languages are supported?</h3>
                ...
                <div className="mb-6 bg-white rounded-xl shadow-md overflow-hidden">
                <div className="p-6">
                    <h3 className="font-bold text-indigo-800 text-lg mb-2">Can I create content in my native language?</h3>
                ...
                <div className="mb-6 bg-white rounded-xl shadow-md overflow-hidden">
                <div className="p-6">
                    <h3 className="font-bold text-indigo-800 text-lg mb-2">Is the WhatsApp integration available in all regions?</h3>
